...
export default function PillMenu({primaryLabel = "Save", secondaryLabel = "Cancel", primaryColor = "#caead3", secondaryColor = "#252525", primaryTextColor = "#252525", secondaryTextColor = "#aaaaaa", dropShadow = false, primaryClick, secondaryClick}) {
    return (
